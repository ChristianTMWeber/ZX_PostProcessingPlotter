...
def drawSetOfHists( histList , drawOptions = [] ): 
    ...
    canvasPDF = ROOT.TCanvas( histList[0].GetName(), histList[0].GetName() ,1300/2,1300/2)
...
if __name__ == '__main__':
    ...
    aCanvas = drawSetOfHists( morphedHistList , drawOptions = ["E1"] )
